...
; classinit.asm
;
;  Library initialisation table and ROMTAG for ilus.datatype.
;  Mirrors dr2d/classinit.asm.  datatypes.library opens the class
...
; ObtainILUSEngine
;
; Return the BOOPSI class pointer for ilus.datatype.  This is the
