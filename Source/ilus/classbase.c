...
/*****************************************************************************/
/* classbase.c -- library lifecycle for ilus.datatype                        */
/*                                                                           */
/* ilus.datatype is a thin subclass of drawing.datatype.  Lifecycle is the   */
    ...
    if (cb->cb_UsageCnt == 1)
    {
        if (cb->cb_Class == NULL)
        {
            ...
            if ((DataTypesBase = OpenLibrary ("datatypes.library", 0)) != NULL)
            {
                ...
                {
                    /* drawing.datatype is our super class.  It lives in     *
                     * SYS:Classes/DataTypes, reachable through the LIBS:    *
                     * multi-assign to SYS:Classes as                        *
                     * "datatypes/drawing.datatype".                         */
                    if ((SuperClassBase =
